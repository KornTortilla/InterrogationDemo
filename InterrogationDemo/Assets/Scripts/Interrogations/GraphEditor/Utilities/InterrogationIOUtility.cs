...
namespace Interrogation.Utilities
{
    ...
    public class InterrogationIOUtility
    {
        ...
        public static void Save()
        {
            ...
            InterrogationGraphSaveDataSO graphData = CreateAsset<InterrogationGraphSaveDataSO>("Assets/Scripts/Interrogations/GraphEditor/SavedGraphs", graphFileName);
        ...
        {
            InterrogationGraphSaveDataSO graphData = LoadAsset<InterrogationGraphSaveDataSO>("Assets/Scripts/Interrogations/GraphEditor/SavedGraphs", graphFileName);
        ...
        {
            //Graph Data
            CreateFolder("Assets/Scripts/Interrogations/GraphEditor", "SavedGraphs");
